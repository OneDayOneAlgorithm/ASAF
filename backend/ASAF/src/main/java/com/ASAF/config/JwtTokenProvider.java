...
public class JwtTokenProvider {
    ...
    private final Key jwtSecret = Keys.secretKeyFor(SignatureAlgorithm.HS512); // 여기에 사용하려는 JWT 비밀 키를 적어주세요.
    private final long jwtExpirationInMs = 3600000; // 토큰 만료 시간 (1시간)
